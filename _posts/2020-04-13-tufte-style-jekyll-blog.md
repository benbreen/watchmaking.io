...
{% locallink '/articles/20/Edge-Cases' 'zzzzz' %}
{% locallink '/articles/20/tufte-style-jekyll-blog#epigraphs' 'this page' %}
{% locallink 'http://rmarkdown.rstudio.com/examples/tufte-handout.pdf' 'handout' %}
